...
st.set_page_config(
    page_title="11655 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    avg_CL = st.sidebar.number_input("Average Credit Limir", 0, 100000)
    ...
    if st.sidebar.button("Prediksi!"):
        ...
        cluster_method = [
            ("kMeans_model", models['kMeans_model'], "KMeans Clusterting", px.colors.sequential.Cividis),
            ("AGG_model", models['AGG_model'], "Agglomerative Clusterting", px.colors.sequential.Mint),
            ("DBSCAN_model", models['DBSCAN_model'], "DBSCAN Clusterting", px.colors.sequential.Plasma)
        ]
